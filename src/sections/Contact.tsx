      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center">
        ...
        <div className="contact-container">
          ...
          <p className="mt-3 text-lg text-white-600">
            Whether you&apos;re hiring for an AI/ML role, looking to ship an
            LLM-powered feature, or want to collaborate on a research or
            engineering project, I&apos;d love to hear from you.
          </p>
